...
const translations = {
  "en": {
    ...
    "Devido a um Acordo de Confidencialidade ": "Due to a Non-Disclosure Agreement ",
    "(NDA),": "(NDA),",
    "apenas alguns detalhes sobre este projeto podem ser compartilhados. Esta seção se concentrará nas tecnologias com as quais trabalhei e aprendi durante o processo de desenvolvimento.": "only a few details about this project can be shared. This section will focus on the technologies I worked with and learned during the development process.",
    "Neste projeto, utilizamos o Docker para garantir consistência e facilidade de implantação em diversos ambientes. Os contêineres Docker permitiram que cada serviço e banco de dados funcionasse isoladamente, aumentando a segurança e a escalabilidade.": "In this project, we utilized Docker to ensure consistency and ease of deployment across various environments. Docker containers allowed each service and database to run in isolation, enhancing security and scalability.",
    "Tecnologias Utilizadas": "Technologies Used",
    "Contêineres Docker": "Docker Containers",
    "Usamos Docker para conteinerizar toda a aplicação, garantindo consistência em diferentes ambientes e simplificando o processo de implantação. Cada banco de dados e serviço funcionava em seu próprio contêiner isolado.": "We used Docker to containerize the entire application, ensuring consistency across different environments and simplifying the deployment process. Each database and service ran in its own isolated container.",
    "Git": "Git",
    "O Git foi essencial para o controle de versão, permitindo colaboração eficiente e rastreamento de mudanças durante todo o desenvolvimento do projeto.": "Git was essential for version control, enabling efficient collaboration and tracking changes throughout the project's development.",
    "MySQL e PostgreSQL": "MySQL and PostgreSQL",
    "Integramos dois bancos de dados distintos,": "We integrated two distinct databases,",
    "MySQL e PostgreSQL,": "MySQL and PostgreSQL,",
    "garantindo um fluxo de dados contínuo e sincronização entre eles.": "ensuring seamless data flow and synchronization between them.",
    "Isso envolveu a escrita de consultas SQL complexas e a gestão de conflitos de dados.": "This involved writing complex SQL queries and managing data conflicts.",
    "Desenvolvimento Web": "Web Development",
    "Desenvolvemos uma interface online responsiva e intuitiva usando tecnologias web modernas como HTML, CSS e JavaScript, facilitando a interação do usuário com os bancos de dados integrados.": "Developed a responsive and intuitive online interface using modern web technologies such as HTML, CSS, and JavaScript, facilitating user interaction with the integrated databases.",
    "Python": "Python",
    "Usamos Python para criar testadores automatizados para os sistemas, garantindo a qualidade e eficiência das integrações e funcionalidades desenvolvidas.": "Used Python to create automated testers for the systems, ensuring the quality and efficiency of the integrations and functionalities developed.",
    "Integração de Tecnologia": "Technology Integration",
    "Integração de Backend e Frontend": "Backend and Frontend Integration",
    "Conectamos a interface frontend com os serviços de backend usando APIs, incluindo autenticação de usuário, validação de dados e tratamento de erros para garantir uma experiência do usuário suave.": "Connected the frontend interface with backend services using APIs, including user authentication, data validation, and error handling to ensure a smooth user experience.",
    "Segurança e Conformidade": "Security and Compliance",
    "Garantimos a segurança dos dados por meio de criptografia, controles de acesso seguros e auditorias de segurança regulares. A conformidade com os padrões e regulamentos da indústria foi mantida para proteger dados sensíveis.": "Ensured data security through encryption, secure access controls, and regular security audits. Compliance with industry standards and regulations was maintained to protect sensitive data.",
    ...
    "Para mais informações detalhadas sobre este projeto,": "For more detailed information about this project,",
    "consulte o Acordo de Confidencialidade ": "please refer to the Non-Disclosure Agreement ",
  ...
  "pt": {
    ...
    "Due to a Non-Disclosure Agreement ": "Devido a um Acordo de Confidencialidade ",
    "(NDA),": "(NDA),",
    "only a few details about this project can be shared. This section will focus on the technologies I worked with and learned during the development process.": "apenas alguns detalhes sobre este projeto podem ser compartilhados. Esta seção se concentrará nas tecnologias com as quais trabalhei e aprendi durante o processo de desenvolvimento.",
    "In this project, we utilized Docker to ensure consistency and ease of deployment across various environments. Docker containers allowed each service and database to run in isolation, enhancing security and scalability.": "Neste projeto, utilizamos o Docker para garantir consistência e facilidade de implantação em diversos ambientes. Os contêineres Docker permitiram que cada serviço e banco de dados funcionasse isoladamente, aumentando a segurança e a escalabilidade.",
    "Technologies Used": "Tecnologias Utilizadas",
    "Docker Containers": "Contêineres Docker",
    "We used Docker to containerize the entire application, ensuring consistency across different environments and simplifying the deployment process. Each database and service ran in its own isolated container.": "Usamos Docker para conteinerizar toda a aplicação, garantindo consistência em diferentes ambientes e simplificando o processo de implantação. Cada banco de dados e serviço funcionava em seu próprio contêiner isolado.",
    "Git": "Git",
    "Git was essential for version control, enabling efficient collaboration and tracking changes throughout the project's development.": "O Git foi essencial para o controle de versão, permitindo colaboração eficiente e rastreamento de mudanças durante todo o desenvolvimento do projeto.",
    "MySQL and PostgreSQL": "MySQL e PostgreSQL",
    "We integrated two distinct databases,": "Integramos dois bancos de dados distintos,",
    "MySQL and PostgreSQL,": "MySQL e PostgreSQL,",
    "ensuring seamless data flow and synchronization between them.": "garantindo um fluxo de dados contínuo e sincronização entre eles.",
    "This involved writing complex SQL queries and managing data conflicts.": "Isso envolveu a escrita de consultas SQL complexas e a gestão de conflitos de dados.",
    "Web Development": "Desenvolvimento Web",
    "Developed a responsive and intuitive online interface using modern web technologies such as HTML, CSS, and JavaScript, facilitating user interaction with the integrated databases.": "Desenvolvemos uma interface online responsiva e intuitiva usando tecnologias web modernas como HTML, CSS e JavaScript, facilitando a interação do usuário com os bancos de dados integrados.",
    "Python": "Python",
    "Used Python to create automated testers for the systems, ensuring the quality and efficiency of the integrations and functionalities developed.": "Usamos Python para criar testadores automatizados para os sistemas, garantindo a qualidade e eficiência das integrações e funcionalidades desenvolvidas.",
    "Technology Integration": "Integração de Tecnologia",
    "Backend and Frontend Integration": "Integração de Backend e Frontend",
    "Connected the frontend interface with backend services using APIs, including user authentication, data validation, and error handling to ensure a smooth user experience.": "Conectamos a interface frontend com os serviços de backend usando APIs, incluindo autenticação de usuário, validação de dados e tratamento de erros para garantir uma experiência do usuário suave.",
    "Security and Compliance": "Segurança e Conformidade",
    "Ensured data security through encryption, secure access controls, and regular security audits. Compliance with industry standards and regulations was maintained to protect sensitive data.": "Garantimos a segurança dos dados por meio de criptografia, controles de acesso seguros e auditorias de segurança regulares. A conformidade com os padrões e regulamentos da indústria foi mantida para proteger dados sensíveis.",
    ...
    "For more detailed information about this project,": "Para mais informações detalhadas sobre este projeto,",
    "please refer to the Non-Disclosure Agreement ": "consulte o Acordo de Confidencialidade ",
